...
/**
 * Client-only QOI helpers for Minecraft textures and resource loading.
 */
@SideOnly(Side.CLIENT)
public final class QoiClientUtil {

    private QoiClientUtil() {}
