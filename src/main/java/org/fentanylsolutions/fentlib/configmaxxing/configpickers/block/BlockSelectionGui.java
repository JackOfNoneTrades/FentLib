...
import org.fentanylsolutions.fentlib.configmaxxing.configpickers.AvailableEntriesListGui;
...
public class BlockSelectionGui extends CommonSelectionGui {
    ...
    public BlockSelectionGui(int index, EntryPoint entryPoint) {
    ...
    public void initGui() {
        ...
        /* The list element */
        this.availableEntriesListGui = new AvailableEntriesListGui(
            60,
            this.height - 30,
            0 /* this.width / 4 * 3 */,
            this.height,
