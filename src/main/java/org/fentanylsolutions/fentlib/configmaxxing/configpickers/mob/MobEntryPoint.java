...
public class MobEntryPoint extends EntryPoint {

    public MobEntryPoint(GuiConfig owningScreen, GuiConfigEntries owningEntryList, IConfigElement configElement) {
        super(owningScreen, owningEntryList, configElement, MobSelectionGui.class);
    }
